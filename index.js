...
// const tanisha = new player(playerposition.x, playerposition.y, 15, "blue");
// tanisha.draw();
const tanisha = new player(
    playerposition.x,
    playerposition.y,
    15,
    "white"
...
function animation() {
    ...
    enemies.forEach((enemy, enemyindex) => {
        enemy.update();
        const distancebetweenbandaandenemy = Math.hypot(tanisha.x - enemy.x, tanisha.y - enemy.y);
        if (distancebetweenbandaandenemy - tanisha.radius - enemy.radius < 1) {
